...
const jobs = [
  {
    ...
    textBlock: [
      ...
      "The ideal candidate is energetic, enjoys working in a fast-paced environment, and has recently graduated University and has a Bachelor's in Accounting. This is a perfect opportunity for an individual looking to start their career with a growing accounting firm in downtown Vancouver.",
  ...
  },
  {
    ...
    firstTextBlockTitle: "About the job",
    textBlock: [
      "We have a career opportunity for a receptionist to join our Vancouver department.",
      "The ideal candidate is energetic, enjoys working in a fast-paced environment. This is a perfect opportunity for an individual looking to advance their career with a growing accounting firm in downtown Vancouver.",
      "We offer an open, collaborative work environment and are involved in a variety of accounting projects across Canada.",
  ...
  },
  {
    ...
    firstTextBlockTitle: "About the job",
    textBlock: [
      "We have a career opportunity for a Senior Accountant to join our Vancouver department.",
      "The ideal candidate is energetic, enjoys working in a fast-paced environment, and has recently graduated University and has a Master's in Accounting. This is a perfect opportunity for an individual looking to advance their career with a growing accounting firm in downtown Vancouver.",
      "We offer an open, collaborative work environment and are involved in a variety of accounting projects across Canada.",
      "As part of our team, you will have the opportunity to experience accounting on many levels. You will work closely with colleagues and senior management on projects throughout all phases.",
      "The ideal candidate has co-op or internship experience at an accounting firm. The characteristics we look for is being self-motivated, hard-working, and people who form collaborative relationships with colleagues and clients.",
      "A resume and transcript are required when applying.",
...
const Job = ({ id }) => {
  ...
  return (
    <>
      {" "}
      <Head>
        <title key="title">Careers | Farhad Dental Care Toronto</title>{" "}
        {/* <meta
          name="description"
          key="description"
