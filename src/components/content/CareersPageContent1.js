...
export default function HowItWorks(props) {
  ...
  const content = {
    ...
    description:
      "Lewis & Co is growing its team. We are looking for individuals who are excited to learn and can work in a fast paced environment, whose work ethic demonstrates these traits and forms collaborative relationships within our team and with clients.",
    description2:
